...
ServerView_ServerPresenter.h、ServerView_ServerPresenter.cpp - 对话框
    这些文件包含 ServerView 类。此类定义应用程序的主对话框的行为。对话框模板包含在 Server.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
